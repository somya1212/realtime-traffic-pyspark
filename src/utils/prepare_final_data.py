"""
script to prepare PEMS data for streaming pipeline.

- drop lane-level columns
- clean out bad rows
- fix timestamp format
- add a simple region column
"""
...
def prepare_final_data(input_file, output_file=None):
    ...
    try:
        ...
        # drop rows where total flow is NaN
        ...
        # drop rows where avg speed is NaN
        ...
        if 'District' in df_cleaned.columns:
            # for this dataset everything is district 7 : "LA"
